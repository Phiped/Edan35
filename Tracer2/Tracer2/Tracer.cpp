...
int main(void)
{
	...
	do {
		...
		glUniform3f(glGetUniformLocation(computeHandle, "spheres[0].center"), 1.0 + sin(totFrames++*0.001f), 7.0 + cos(totFrames++*0.001f), 0.0);
		glUniform1f(glGetUniformLocation(computeHandle, "spheres[0].radius"), 2.0);
		...
		glUniform3f(glGetUniformLocation(computeHandle, "planes[1].point"), 10.0, 10.0, 10.0);
